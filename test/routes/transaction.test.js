...
beforeAll( async () => {
	...
	const users = await app.db('users').insert([
		{ name: 'User #1', mail: 'user@mail.com', password: '$2a$10$B0Z3zBN3yX/G7/u2rdfsSu6tuLmTMK0leUGRLpzDo7S07nI2lGScm'},
		{ name: 'User #2', mail: 'user2@mail.com', password: '$2a$10$B0Z3zBN3yX/G7/u2rdfsSu6tuLmTMK0leUGRLpzDo7S07nI2lGScm'},		
	], '*');
...
test('Deve listar apenas as transações do usuário', () => {
	 //2 usuarios, 2 contas, 2 transaçoes
...
test('Não deve manipular uma transação de outro usuário', () => {
	return app.db('transactions').insert(
...
test('Não deve remover conta com uma transação', () => {
	return app.db('transactions').insert(
		{description: 'To delete', date: new Date(), ammount: 100, type: 'I', acc_id: accUser.id}, ['id'])
